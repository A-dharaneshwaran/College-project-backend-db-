...
export default function AdminMessagesScreen() {
  ...
  const handleNewBroadcast = () => {
    alert('Broadcast creation modal would open here.');
  };
    ...
    <View style={styles.container}>
      <View style={styles.topHeader}>
        ...
        <View style={styles.headerButtonsRow}>
          <TouchableOpacity style={styles.broadcastBtn} onPress={handleNewBroadcast}>
          ...
          >
            <FontAwesome name={showArchived ? "comments" : "archive"} size={16} color="#1a237e" />
